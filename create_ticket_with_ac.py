...
async def create_jira_ticket():
    ...
    # Proper ADF format for description and acceptance criteria
    payload = {
        "fields": {
            "project": {"key": "PH"},
            ...
            "description": {
                ...
                "content": [
                    {
                        "type": "paragraph",
                        "content": [{"type": "text", "text": "PR #46 (PH-2286) requires WO_JOB_MGMT_URL environment variable for WO callback sensors."}]
                    },
                    {
                        "type": "heading",
                        "attrs": {"level": 3},
                    ...
                    {
                        "type": "paragraph",
                        "content": [{"type": "text", "text": "Timeline: Before deploying PH-2286 to DevInt"}]
                    }
                ]
            },
            "customfield_10958": {  # Acceptance Criteria field
                "type": "doc",
                "version": 1,
                "content": [
                    {
                        "type": "bulletList",
                        "content": [
                            {"type": "listItem", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "WO_JOB_MGMT_URL added to DevInt .env file"}]}]},
                            {"type": "listItem", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "autofov-code-location container starts successfully"}]}]},
                            {"type": "listItem", "content": [{"type": "paragraph", "content": [{"type": "text", "text": "No RuntimeError about missing WO_JOB_MGMT_URL"}]}]}
                        ]
                    }
                ]
            }
